import type { LitAnalyzerContext, LitDiagnostic } from "@genexus/kasstor-lit-analyzer";
...
function translateDiagnostic(diagnostic: LitDiagnostic, file: SourceFile, context: LitAnalyzerContext): DiagnosticWithLocation {
	...
	return {
		...
		category,
		code,
		source: diagnostic.source == null ? undefined : `kasstor-lit-analyzer(${diagnostic.source})`
	};
}
