import type { LitAnalyzerConfig, LitAnalyzerContext } from "@genexus/kasstor-lit-analyzer";
import { DefaultLitAnalyzerContext, LitAnalyzer, makeConfig } from "@genexus/kasstor-lit-analyzer";
