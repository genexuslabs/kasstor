import type { Node, TaggedTemplateExpression } from "typescript";
import type { HtmlDocument } from "../../lib/analyze/parse/document/text-document/html-document/html-document.js";
