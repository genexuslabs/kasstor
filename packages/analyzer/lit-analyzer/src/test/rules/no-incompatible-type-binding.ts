...
tsTest("Generic element in HTMLElementTagNameMap: binding the wrong literal is flagged", t => {
	const { diagnostics } = getDiagnostics(`
...
tsTest("Generic element in HTMLElementTagNameMap: binding a valid literal type-checks", t => {
	const { diagnostics } = getDiagnostics(`
		import { LitElement, html, property, customElement } from 'lit-element';
