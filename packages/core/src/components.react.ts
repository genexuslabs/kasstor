...
export namespace ComponentPropertiesReact {
...
declare namespace ReactJSX {
  export type KstTheme = Omit<ReactDetailedHTMLProps<ReactHTMLAttributes<HTMLKstThemeElement>, HTMLKstThemeElement>, keyof ComponentPropertiesReact.KstTheme> & ComponentPropertiesReact.KstTheme & {
    /**
