...
export type KasstorBuildOptions = {
  ...
  fileGeneration?:
    ...
    | {
         ...
         * projects that depend on React. It depends on the
         * `exportTypesForTheLibrary` file (its global custom-element types and
         * the re-exported property types), so that file MUST also be generated
