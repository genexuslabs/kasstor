...
export type KasstorBuildOptions = {
  ...
  fileGeneration?:
    ...
    | {
         ...
         *
         * Default: "components.react.ts" (generated). Set to `false` to disable
         * (e.g. for non-React projects), or to a string to rename it.
         */
        exportTypesForReact?: string | false;

        /**
         * SolidJS JSX types file. Same as `exportTypesForReact` but for SolidJS
         * (imports `solid-js`). Opt-in: default `false`; set a file name (e.g.
         * "components.solid.ts") to enable.
         */
        exportTypesForSolidJs?: string | false;

        /**
         * StencilJS JSX types file. Same as `exportTypesForReact` but for
         * StencilJS (imports `@stencil/core`). Opt-in: default `false`; set a
         * file name (e.g. "components.stencil.ts") to enable.
         */
